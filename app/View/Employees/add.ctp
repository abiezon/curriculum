...
<?php $this->Html->addCrumb('Adicionar Funcionário');?>
<div id="content">
	<div class="box">
<!-- <div class="box"> -->
	<!-- Box Head -->
	<div class="box-head">
		<h2><?php echo __('Novo Funcionário'); ?></h2>
	</div>
	<!-- End Box Head -->
	...
	<?php echo $this->Form->create('Employee'); ?>	
		...
		<div class="form">
     	  ...
     	  echo $this->Form->input('roles_id',array('empty' => __('Selecione'),'class'=>'field','label'=>'Função'));
     		...
     		echo $this->Form->input('mariage_status',array('type'=>'select','options'=>$this->Home->maritalStatus(),'class'=>'field','label'=>'Estado Civil'));
