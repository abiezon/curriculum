  ...
  foreach ($employees as $employee): ?>
	<tr>
		...
		<td class="actions">
			...
			<?php echo $this->Form->postLink(__('Delete'),array('action' => 'delete', $employee['Employee']['id']), array('class'=>'replace btn-deletar'), __('Are you sure you want to delete # %s?', $employee['Employee']['name'])); ?>
		</td>
	</tr>
<?php endforeach; ?>
	</table>
